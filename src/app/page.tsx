...
import { ethereumPrivateKeyValidator, exportPublicKeyFromPrivate, getEthBalance } from "@/utils/ethers";
import { getStoredEthPrivateKey, STORED_KEY_NAME } from "@/utils/localstorage";
        ...
        <div>
            ...
            {ethPrivateKey?.length && (
                <div>
                    ...
                    <p className="text-green-500 mt-4">ETH Public Key: {ethPublicKey}</p>
                    <p className="text-green-500 mt-4">Balance: {walletBalance ? `${walletBalance} ETH` : 'Loading...'}</p>
                    <button
